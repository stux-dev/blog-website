    ...
    return (
      <div className="relative mb-3 group bg-[#1A1A1A] border font-poppins border-[#3C3C3C] rounded-lg p-6 shadow-md hover:shadow-lg hover:border-gray-500 transition-all duration-300 ease-in-out transform hover:-translate-y-1">
                  <div className="flex flex-col h-full">
                      {/* Blog Title - Adjusted font size for mobile */}
                      <h2 className="text-lg md:text-xl font-bold text-gray-100 mb-3 flex-grow group-hover:underline decoration-2 underline-offset-4">
                      ...
                      {/* Author and Date Information - Adjusted font size and added flex-wrap for mobile */}
                      <div className="flex flex-wrap items-center text-xs text-gray-400 mt-4 font-mono">
